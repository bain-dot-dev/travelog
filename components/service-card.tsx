...
export function ServiceCard({
  ...
  return (
    <Card
      className={`rounded-[32px] hover:shadow-xl border hover:border-none hover:drop-shadow-xl backdrop-blur-2xl backdrop-filter transition-shadow h-[279px] md:h-[355px] lg:w-[288px] lg:h-[443px] xl:w-[350px] xl:h-[443px] ${className}`}
    >
