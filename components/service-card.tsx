...
export function ServiceCard({
  ...
  return (
    <Card
      className={`rounded-[32px] shadow-xl border hover:border-none shadow-gray-200/50 hover:drop-shadow-xl transition-shadow h-[279px] lg:w-[288px] lg:h-[443px] xl:w-[350px] xl:h-[443px] ${className}`}
    >
